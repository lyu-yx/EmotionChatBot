# Updated identify.py with 5-second stable heart rate display and race detection
    ...
    def _detection_loop(self, show_video: bool):
        ...
        while self.is_running and self.cap is not None:
            ...
            if self.demographics["age"] is not None:
                demo_text = f"Age: {self.demographics['age']}  Gender: {self.demographics['gender']}  Race: {self.demographics['race']}"
